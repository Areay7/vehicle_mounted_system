...
public:
    ...
    QVBoxLayout *verticalLayout_Battery;
    ...
    QFrame *line;
    QPushButton *btnOpenRemoteWindow;
...
"image: url(:/mainImage/Signal.png);"));
        ...
        widget->setGeometry(QRect(570, -5, 91, 31));
        verticalLayoutWidget = new QWidget(widget);
        verticalLayoutWidget->setObjectName("verticalLayoutWidget");
        verticalLayoutWidget->setGeometry(QRect(20, 10, 71, 21));
        verticalLayout_Battery = new QVBoxLayout(verticalLayoutWidget);
        verticalLayout_Battery->setObjectName("verticalLayout_Battery");
        verticalLayout_Battery->setContentsMargins(0, 0, 0, 0);
...
" }"));
        ...
        btnOpenRemoteWindow = new QPushButton(main);
        btnOpenRemoteWindow->setObjectName("btnOpenRemoteWindow");
        btnOpenRemoteWindow->setGeometry(QRect(720, 460, 151, 51));
        btnOpenRemoteWindow->setStyleSheet(QString::fromUtf8("\n"
" QPushButton:hover {\n"
" \n"
"	border-image: url(:/mainImage/mainWeatherpress.png);\n"
" }\n"
...
""));
    ...
    void retranslateUi(QWidget *MainWidget)
    {
        ...
        btnOpenRemoteWindow->setText(QString());
