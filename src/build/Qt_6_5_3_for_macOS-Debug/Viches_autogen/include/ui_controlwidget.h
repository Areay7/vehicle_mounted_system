...
""));
        ...
        frame->setGeometry(QRect(0, -10, 1001, 571));
...
"background: rgba(0,0,0,0%);"));
        ...
        stackedWidgetSetting->setGeometry(QRect(740, 10, 241, 491));
...
"background-color: rgb(29, 43, 50);"));
        ...
        pageWIFI = new wifiListWidget();
        pageWIFI->setObjectName("pageWIFI");
        pageWIFI->setStyleSheet(QString::fromUtf8("QWidget#pageWIFI\n"
"{\n"
"background-color: rgb(73, 92, 105);\n"
"}"));
        ...
        widgetVoice->setGeometry(QRect(750, 500, 221, 61));
